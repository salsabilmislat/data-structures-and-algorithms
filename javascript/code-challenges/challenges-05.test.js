...
const addValues = (arr) => {
  ...
  let sum = arr.reduce((accumulator, newValue) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  let sum = arr.reduce((accumulator, newValue) => {
    accumulator += newValue.purchasePrice;
    return accumulator;
  }, 0);
  return sum;
};
...
const countNumberOfElements = (arr) => {
  ...
  let numOfElement = arr.reduce((accumulator) => {
    accumulator += 1;
    return accumulator;
  }, 0);
  return numOfElement;
...
const returnNames = (arr) => {
  ...
  let nameOfCharacter = arr.reduce((accumulator, newValue) => {
    accumulator.push(newValue.name);
    return accumulator;
  }, []);
...
const reversedString = (str) => {
  // Solution code here...
  let array = str.split('')
  let arrString = array.reduce((accumulator, newValue) => {
    return newValue + accumulator;
